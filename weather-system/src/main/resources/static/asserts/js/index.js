...
function chooseImg(id, index) {
    switch (id) {
        case '1':
            index.src = 'asserts/img/weather_icon/1.png';
            break;
        case '2':
            index.src = 'asserts/img/weather_icon/2.png';
            break;
        case '3':
            index.src = 'asserts/img/weather_icon/3.png';
            break;
        case '4':
        case '5':
        case '6':
        ...
        case '25':
        case '26':
            index.src = 'asserts/img/weather_icon/4.png';
            break;
        case '7':
            index.src = 'asserts/img/weather_icon/6.png';
            break;
        case '14':
        case '15':
        case '16':
        ...
        case '28':
        case '29':
            index.src = 'asserts/img/weather_icon/5.png';
            break;
        case '19':
        case '21':
        case '30':
        ...
        case '32':
        case '33':
            index.src = 'asserts/img/weather_icon/7.png';
            break;
        default:
            index.src = 'asserts/img/weather_icon/8.png';
    }
}
